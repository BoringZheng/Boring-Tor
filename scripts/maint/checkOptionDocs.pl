...
open(F, "/home/boringzheng/Desktop/tor-0.4.8.14/src/app/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/boringzheng/Desktop/tor-0.4.8.14/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/boringzheng/Desktop/tor-0.4.8.14/doc/man/tor.1.txt") or die;
while (<F>) {
