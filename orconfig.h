...
/* # for 0.4.8.18 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2025-09-16"

/* tor's build directory */
#define BUILDDIR "/root/tor-lab/tor"
...
#define PACKAGE_STRING "tor 0.4.8.18"
...
#define PACKAGE_VERSION "0.4.8.18"
...
#define SRCDIR "/root/tor-lab/tor"
